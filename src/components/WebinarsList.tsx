            ...
            <div className="p-6 space-y-6">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <input 
                    readOnly 
                    value={`https://salecrib.com/webinar/reg/${linksModalWebinar.slug}`} 
                ...
                <label className="block text-sm font-medium text-slate-700 dark:text-zinc-300">Embed Registration Form</label>
                 ...
                 <div className="relative">
                   <textarea 
                     readOnly 
                     rows={3} 
                     value={`<iframe src="https://salecrib.com/webinar/reg/${linksModalWebinar.slug}/embed" width="100%" height="450px" frameborder="0"></iframe>`}
